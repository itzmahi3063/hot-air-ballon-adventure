...
export default function ReferTab({ user, onInviteBonus }) {
  ...
  // Generate invite link using the user's Telegram ID (matches backend referral logic)
  const inviteLink = `https://t.me/${referralConfig.botUsername}?start=ref_${user.telegramId}`;
